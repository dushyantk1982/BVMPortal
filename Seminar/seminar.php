        ...
        <table width="100%" align="center" bordercolor="#A8B1DE" background="../images/NEWSIDE.png">
          <tr valign="top" background=>
            <td width="14%" valign="middle" ><div align="center">
              <p><a href="seminar.php?id=1" >Conference</a> </p>
              <p><a href="seminar.php?id=2" >About Gwalior</a></p>
              <p><a href="seminar.php?id=3" >Objectives</a></p>
              <p><a href="seminar.php?id=4" >Schedule</a></p>
              <p><a href="brochure.pdf" target="_blank" >Brochure</a></p>
			  <p><a href="5.pdf" target="_blank" >Registration</a></p>
			...
			@$id=$_REQUEST['id'];
			if($id==1)
			{?><img src="1.jpg" width="100%" height="700" /><?php
			}
			else if($id==2)
			{?><img src="3.jpg" width="100%" height="700" /><?php }
			else if($id==3)
			{?><img src="4.jpg" width="100%" height="700" /><?php }
			else if($id==4)
			{?>
			<img src="2.jpg" width="100%" height="700" />
			
			<?php
			} 
			else
			{?><img src="1.jpg" width="100%" height="700" />
			<?php 
			}
			?>			</td>
            </tr>
