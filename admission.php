        ...
        <table width="100%" align="center" bordercolor="#A8B1DE" background="images/NEWSIDE.png">
          <tr valign="top" background=>
            <td width="14%" valign="middle" ><div align="center">
              <script Webstyle4 src="images/links.js"></script>
            </div></td>
            <td width="86%" background="images/newback.jpg" style="border:solid;border-color:#003300;"><?php 
			if(@$_REQUEST['id']==1)
			{?>
              <iframe height="500" width="100%" src="mca.php" name="admission"></iframe>
              <?php
			}
			else if(@$_REQUEST['id']==2)
			{?>
              <iframe height="500" width="100%" src="mba.php" name="admission"></iframe>
			<?php }
			else if(@$_REQUEST['id']==3)
			{?><iframe height="500" width="100%" src="be.php" name="admission"></iframe>
			<?php }
			else if(@$_REQUEST['id']==4)
			{?><iframe height="500" width="100%" src="bca.php" name="admission"></iframe>
			<?php }
			else if(@$_REQUEST['id']==5)
			{?><iframe height="500" width="100%" src="bba.php" name="admission"></iframe>
			<?php }	
			else if(@$_REQUEST['id']==6)
			{?><iframe height="500" width="100%" src="bed.php" name="admission"></iframe>
			<?php }	
			else if(@$_REQUEST['id']==7)
			{?><iframe height="500" width="100%" src="ded.php" name="admission"></iframe>
			<?php }	
			else if(@$_REQUEST['id']==5)
			{?><iframe height="500" width="100%" src="ntt.php" name="admission"></iframe>
			<?php }									
			else
			{?><iframe height="500" width="100%" name="admission" ></iframe><?php }?>				
</td>
            </tr>
