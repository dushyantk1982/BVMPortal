...
<div id="Layer2">
  <table width="90%" align="center" background="images/NEWSIDE.png" >
    <tr >
      <td width="90%" valign="top" background="images/tabback.jpg" style="border-bottom:thick;border-bottom-color:#5671A3;"><?php include("header.php"); ?></td>
    </tr>
    <tr valign="top">
      <td width="90%"><table width="100%" align="center">
        ...
        <table width="100%" align="center" bordercolor="#A8B1DE" background="images/NEWSIDE.png">
          <tr valign="top" background=>
            ...
            <td width="86%" background="images/newback.jpg" style="border:solid;border-color:#003300;"><iframe height="500" width="100%" name="about" src="placement.php"></iframe>			
</td>
            </tr>
