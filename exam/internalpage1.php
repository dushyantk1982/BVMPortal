...
<body><div class="style2" id="Layer4" style="border:solid;border-color:#003300;">
                        <form action="insertinternal1.php" method="post" onsubmit="MM_validateForm('session','','R');return document.MM_returnValue" >
...
echo "<tr align='center'>
	...
	<td align='right'><input type='text' name='fno[]' value=".$r['file_no']."  size='12' readonly='yes' /></td>
