		...
		<div class="layer1">
			...
			<span style="color: #B7B7B7">
				<marquee behavior="scroll" direction="left" style="background-color:#990000;">
					<span class="style44" style="font-family: &quot;Courier New&quot;, Courier, monospace">Welcome to BVM Faculty Login</span>
				</marquee>
			</span>
		</div>
...
<form action="check_faculty_login.php" method="post">
...
<table width="30%" align="center" bordercolor="#003333" class="pagefont">
	...
	<tr>
		<td align="center" colspan="9">
			<tr>
				<td width="19%">
					<div align="left" class="style8">Faculty ID</div>
				</td>
				<td width="30%">
                   	<input name="loginid" type="text" id="loginid" placeholder="Enter Faculty ID" />
                   </td>
			</tr>
            <tr>
			...
			<tr>
				<td colspan="9" align="center">
					<div align="center" class="style31">
                    	<input name="ok" type="submit" class="style30" value="Sign In" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="faculty_reg.php"><span class="style14 style13">Sign Up</span></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://bvmgroup.org/"><span class="style14 style13">Home</span></a></div>
				</td>
			</tr>
		</td>
	</tr>
...
<div align="center">
	<?php
		if(@$_REQUEST['msg']=='login')
		{
			echo "Registration has been completed successfully! Please contact admin to activate your faculty id";
		}
