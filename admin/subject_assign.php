						  ...
						  <tr>
                              ...
                              <td width="100%"><label>
                                <?php
									...
									echo "<select name='faculty'><option value=''>--Select--</option>";
									$res=mysql_query('select * from faculty_reg where ststus="Active"');
...
echo "<tr align='center'>
	...
	<td align='right'><select name='code[]'>
							...
							<option value='MBA2JU001'>MBA 2(JU001)</option>
							<option value='MBA301'>MBA 301</option>
							<option value='MBA302'>MBA 302</option>
							<option value='MBA303'>MBA 303</option>
							<option value='MBA3FM01'>MBA3 FM01</option>
							<option value='MBA3FM02'>MBA3 FM02</option>
							<option value='MBA3HR01'>MBA3 HR01</option>
							<option value='MBA3HR02'>MBA3 HR02</option>
							<option value='MBA3IB01'>MBA3 IB01</option>
							<option value='MBA3IB02'>MBA3 IB02</option>
							<option value='MBA3MK01'>MBA3 MK01</option>
							<option value='MBA3MK02'>MBA3 MK02</option>
							<option value='MBA401'>MBA 401</option>
							<option value='MBA402'>MBA 402</option>
							<option value='MBA4FM03'>MBA4 FM03</option>
							<option value='MBA4FM04'>MBA4 FM04</option>
							<option value='MBA4HR03'>MBA4 HR03</option>
							<option value='MBA4HR04'>MBA4 HR04</option>
							<option value='MBA4IB03'>MBA4 IB03</option>
							<option value='MBA4IB04'>MBA4 IB04</option>
							<option value='MBA4MK03'>MBA4 MK03</option>
							<option value='MBA4MK04'>MBA4 MK04</option>
							<option value='MBA4OP01'>MBA4 OP01</option>
							<option value='MBA4OP02'>MBA4 OP02</option>
							...
							<option value='MCA405ME'>MCA 405(ME)</option>
							<option value='MCA405Jav'>MCA 405(Java)</option>
							<option value='MCA501'>MCA 501</option>
							<option value='MCA502'>MCA 502</option>
							<option value='MCA503'>MCA 503</option>
							<option value='MCA504OB'>MCA 504(OB)</option>
							<option value='MCA504NET'>MCA 504(DotNet)</option>
							...
							<option value='BBA504FM'>BBA504 FM</option>
							<option value='BBA504HR'>BBA504 HR</option>
							<option value='BBA504MK'>BBA504 MK</option>
							<option value='BBA505FM'>BBA505 FM</option>
							<option value='BBA505HR'>BBA505 HR</option>
							<option value='BBA505MK'>BBA505 MK</option>
							<option value='BBA506FM'>BBA506 FM</option>
							<option value='BBA506HR'>BBA506 HR</option>
							<option value='BBA506MK'>BBA506 MK</option>
							<option value='BBA601'>BBA 601</option>
							<option value='BBA602'>BBA 602</option>
							<option value='BBA603'>BBA 603</option>
							<option value='BBA604FM'>BBA604 FM</option>
							<option value='BBA604HR'>BBA604 HR</option>
							<option value='BBA604MK'>BBA604 MK</option>
							<option value='BBA605FM'>BBA605 FM</option>
							<option value='BBA605HR'>BBA605 HR</option>
							<option value='BBA605MK'>BBA605 MK</option>
							<option value='BBA606FM'>BBA606 FM</option>
							<option value='BBA606HR'>BBA606 HR</option>
							<option value='BBA606MK'>BBA606 MK</option>
