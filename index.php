...
function clicker(){
	...
	if(thediv.style.display == "none"){
		...
		thediv.innerHTML = "<table width='100%' height='100%'><tr><td align='center' valign='middle' width='100%' height='100%'><object classid='clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B' codebase='images/ganesh.jpg' width='640' height='500'><param name='src' value='images/ganesh.jpg'><param name='bgcolor' value='#000000'><embed src='images/ganesh.jpg' autoplay='true' pluginspage='#' height='500' width='640' bgcolor='#000000'></embed></object><br><br><a href='#' onclick='return clicker();'>CLOSE WINDOW</a></td></tr></table>";
	}else{
...
<div class="wrapper">
	<div class="head">
		<div class="layer" align="right">
			<a href="index.php?id=51" class="style2">Admission Enquiry</a>|
			<a href="index.php?id=4" class="style2">Site Map</a>|
			<a href="index.php?id=52" class="style2">Contact Us</a>
		</div>
		<div class="layer1">
			<table width="100%">
    			<tr>
      				<td width="25%">
						<div align="right">
							<input type="image" src="images/logo.jpg" alt="BVM Group of Colleges" align="middle" height="80" width="100" />&nbsp;&nbsp;
						</div>
					</td>
                    ...
                    <td width="30%" valign="middle">
						<div align="left" style="vertical-align:top;">
							<a href="http://www.demo.bvmgroup.org"><img height="15" width="160" style="vertical-align:top;" src="images/click.png" /></a>
						</div>
					</td>
				</tr>
				<tr>
			...
			<span style="color: #B7B7B7">
				<marquee behavior="scroll" direction="left" style="background-color:#660000;">
					...
					<span style="font-family: &quot;Courier New&quot;, Courier, monospace" style="color:#660000;"><font color="#660000">BVM</font> </span>
				</marquee>
			</span>
		</div>
		<div class="layer2">
	...
	<div class="container">
		...
		?>
		<iframe align="middle" height="670" width="100%" src="student/chksyllab.php" name="index"></iframe>
		<?php
			} else if(@$_REQUEST['id']==13){
		?>
		<iframe align="middle" height="670" width="100%" src="teaching.php" name="index"></iframe>
		<?php
			} else if(@$_REQUEST['id']==14.1){
		?>
		<iframe align="middle" height="670" width="100%" src="pgprogram.php" name="index"></iframe>
		<?php
			} else if(@$_REQUEST['id']==14.2){
		?>
		<iframe align="middle" height="670" width="100%" src="ugprogram.php" name="index"></iframe>
		...
		<?php
			} else if(@$_REQUEST['id']==41.1){
		?>
		<iframe align="middle" height="670" width="100%" src="gallery/Conference/4th/conference.php" name="index"></iframe>
		<?php
			} else if(@$_REQUEST['id']==70){
		?>
		<iframe align="middle" height="670" width="100%" src="gallery/RM/RM.php" name="index"></iframe>
		<?php
			} else if(@$_REQUEST['id']==42.1){
		?>
		<iframe align="middle" height="670" width="100%" src="gallery/harmony/2013/harmony.php" name="index"></iframe>
		<?php
			} else if(@$_REQUEST['id']==42.2){
		?>
		<iframe align="middle" height="670" width="100%" src="gallery/harmony.php" name="index"></iframe>
		<?php
			} else if(@$_REQUEST['id']==43){
		?>
		<iframe align="middle" height="670" width="100%" src="gallery/campus/campus.php" name="index"></iframe>
		<?php
			} else if(@$_REQUEST['id']==44.1){
		?>
		<iframe align="middle" height="670" width="100%" src="gallery/tour/shimla/tour.php" name="index"></iframe>
		<?php
			} else if(@$_REQUEST['id']==44.2){
		?>
		<iframe align="middle" height="670" width="100%" src="gallery/tour/udaypur/tour.php" name="index"></iframe>
		<?php
			} else if(@$_REQUEST['id']==44.3){
		?>
		<iframe align="middle" height="670" width="100%" src="gallery/tour/manali/tour.php" name="index"></iframe>
		<?php
			} else if(@$_REQUEST['id']==44.4){
		?>
		<iframe align="middle" height="670" width="100%" src="gallery/tour/nainital/tour.php" name="index"></iframe>
		<?php
			} else if(@$_REQUEST['id']==44.5){
		?>
		<iframe align="middle" height="670" width="100%" src="gallery/tour/dhumeshwar/tour.php" name="index"></iframe>
		<?php
			} else if(@$_REQUEST['id']==44.6){
		?>
		<iframe align="middle" height="670" width="100%" src="gallery/tour/bhadawna/tour.php" name="index"></iframe>
		<?php
			} else if(@$_REQUEST['id']==44.7){
		?>
		<iframe align="middle" height="670" width="100%" src="gallery/tour/orcha/tour.php" name="index"></iframe>
		<?php
			} else if(@$_REQUEST['id']==45){
		?>
		<iframe align="middle" height="670" width="100%" src="gallery/events/events.php" name="index"></iframe>
		
		<?php
			} else if(@$_REQUEST['id']==51){
		?>
		<iframe align="middle" height="670" width="100%" src="enquiryform1.php" name="index"></iframe>
		<?php
		...
		<?php
			} else if(@$_REQUEST['id']==62){
		?>
		<iframe align="middle" height="670" width="100%" src="whybvm.php" name="index"></iframe>
		<?php
			} else if(@$_REQUEST['id']==63){
		?>
		<iframe align="middle" height="670" width="100%" src="aquardmsg.php" name="index"></iframe>
		<?php
			} else if(@$_REQUEST['id']==64){
		?>
		<iframe align="middle" height="670" width="100%" src="workshop.php" name="index"></iframe>
		
		
		<?php }else{?>
		<iframe align="middle" height="670" width="100%" src="home.php" name="index"></iframe>
		<?php
		}
		?>
		</div>
		<div class="right">
			<?php include("cpdesk.php"); ?><br />
		<div><!--<div style="border:thin solid #003333;"><a href="index.php?id=41.1" target="_parent">--><?php //include("upcomingevents/ncimg.php");//include("cmatmsg.php"); ?><!--</a>--></div>
			<br /><div style="background-image:url(images/get2.jpg); width:240px; height:93px;"><div style="margin-top:50px; margin-left:10px; margin-right:10px; margin-bottom:15px;"><center><font style="color:#FFFFFF; font-size:28px; font-weight:bold; font-family:'Courier New', Courier, monospace;"><a href="http://www.priyachauhan.co.in/conference" target="_blank" style="text-decoration:none; color:#FFFFFF;">National Conference 2016</a></font></center></div></div><!--<img src="images/get1.jpg" alt="Get in Touch" width="240" height="93" align="top" />--><br />
		
		<a href="index.php?id=62" target="_parent"><img src="images/whybvm.jpg" alt="Why BVM?" width="240" height="93" align="top" /></a><br />
		...
		<div class="footer2 style1"><hr />
			<table width="984">
				<tr>
					...
					<td width="8%" align="right">
						<a href="index.php?id=61" title="Asst. Prof. Dushyant Upadhyay IT Dept.">Developed By</a><br />					</td>
				</tr>
		  </table>
		</div>
	</div>
...
<!--<img alt="Website counter" hspace="0" vspace="0" border="0" src="http://www.tucantrafficmonitor.com/7360719-311388FFC92DB2466B3B460AA30DE546/counter.img?theme=1&digits=7&siteId=6"/>-->
 ...
 <!--<a href="http://www.digits.com" target="_blank">
    <img src="http://counter.digits.com/?counter={42b12529-7c8c-55b4-89d1-8f46c016e90f}&template=simple" 
