      ...
      <td width="90%"><table width="100%" align="center">
        ...
        <table width="100%" align="center" bordercolor="#A8B1DE" background="images/NEWSIDE.png">
          <tr valign="top" background=>
            <td width="14%" valign="middle" ><div align="center"><p align="center"><a href="syllabus.php?id=1" target="syllabus" style="color:#003300;" >SYLLABUS</a></p>
			<p align="center"><a href="_notes/janclc2014.pdf?id=2" target="clc" style="color:#003300;" >College Calender<br/ >(Current)</a></p>
			
            </div></td>
            <td width="86%" background="images/newback.jpg" style="border:solid;border-color:#003300;" valign="middle">
	
			<iframe height="500" width="100%" src="syllabus.php" name="syllabus">
			<iframe height="500" width="100%" src="calender.php" name="syllabus">
			</iframe>
