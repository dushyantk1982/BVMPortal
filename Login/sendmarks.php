...
<body><form method="post" name="send" action="internalpage2.php">
<input type="hidden" name="course" id="course" value="<?php $_POST["selcourse"];?>" />
<input type="hidden" name="sem" id="sem" value="<?php $_POST["selsem"];?>" />
<input type="hidden" name="internal" id="internal" value="<?php $_POST["selinternal"];?>" />
<input type="hidden" name="year" id="year" value="<?php $_POST["selyear"];?>" /></form>
<?php
$id=0;
