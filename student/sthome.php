...
<div class="wrapper">
		...
		<div class="layer1">
			...
			<span style="color: #B7B7B7">
				<marquee behavior="scroll" direction="left" style="background-color:#990000;">
					<span class="style44" style="font-family: &quot;Courier New&quot;, Courier, monospace">Welcome to Student Portal </span>
				</marquee>
			</span>
		</div>
		<?php 
	...
	mysql_select_db('bvmgroup_bvmclg');
		...
		<div class="layer2">
			<div style="background-color:#CCCCCC;">
				...
				<a href="http://bvmgroup.org/" target="_parent">Logout</a>
	...
	<div class="container">
		...
		?>
		<iframe align="middle" height="470" width="100%" src="findqb1.php?fileno=<?php echo $fno; ?>" name="sthome"></iframe>
		<?php
		...
		<?php }else{?>
		<iframe align="middle" height="470" width="100%" src="home.php?fileno=<?php echo $fno; ?>" name="index"></iframe>
		<?php
		}
		?>
		</div>
