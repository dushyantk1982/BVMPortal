		...
		<div class="layer1">
			...
			<span style="color: #B7B7B7">
				<marquee behavior="scroll" direction="left" style="background-color:#990000;">
					<span class="style44" style="font-family: &quot;Courier New&quot;, Courier, monospace">Helpline:0751-2341161<!--Admissions are open for 2014-15 | 24 x 7 Helpline:9301129088/9303714455--> </span>
				</marquee>
			</span>
		</div>
...
<form action="chkstlogin.php" method="post">
...
<table width="30%" align="center" bordercolor="#003333" class="pagefont">
	<tr>
		<td align="center" colspan="9">
			<h3 class="style13 style8">STUDENT LOGIN<hr /> </h3>
		</td>
	</tr>
	<tr>
		<td align="center" colspan="9">
			...
			<tr>
				<td colspan="9" align="center">
					<div align="center" class="style31">
                    	<input name="ok" type="submit" class="style30" value="Sign In" /><br /><br /><a href="changepwd.php"><span class="style14 style13">Change Password</span></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="../index.php"><span class="style14 style13">Home</span></a></div>
				</td>
			</tr>
		</td>
	</tr>
