<?php 
	...
	$col=mysql_query("select * from student_reg where file_no=".$fileno." and pwd='".$pwd."' and status='active'",$conn);
	...
	{
		header('location:http://bvmgroup.org/student-desk/?msg=error');
	}
