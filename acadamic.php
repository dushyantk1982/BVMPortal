      ...
      <td width="90%"><table width="100%" align="center">
        ...
        <table width="100%" align="center" bordercolor="#A8B1DE" background="images/NEWSIDE.png">
          <tr valign="top" background=>
            <td width="14%" valign="middle" ><!--<p align="center"><a href="PROGRAM.php" target="admission" style="color:#003300;" >Programs</strong></a></p>-->
                <p align="center"><a href="calender.php" target="admission" style="color:#003300;" >Calendar</a></p>
                <p align="center"><a href="student/checkit.php" target="admission" style="color:#003300;" >Syllabus</a></p>
                <p align="center" ><a href="teaching.php" target="admission" style="color:#003300;">Teaching Methodology</a></p>
                </td>
			...
			{?><iframe height="500" width="100%" src="student/checkit.php" name="admission"></iframe>
			<?php }
			...
			{?><iframe height="500" src="program.php" width="100%" name="admission" ></iframe><?php }?>			
